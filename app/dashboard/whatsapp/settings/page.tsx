  ...
  return (
    <div style={{ background: '#fff', minHeight: '100vh' }}>
      ...
      <div style={{ padding: 24, maxWidth: 800, margin: '0 auto' }}>
        {/* Company selector */}
        <div className="card" style={{ background: '#fff', borderRadius: 14, padding: '16px 20px', marginBottom: 20, boxShadow: '0 1px 3px rgba(0,0,0,.06)' }}>
          <label style={{ fontSize: 11, color: '#6b7280', display: 'block', marginBottom: 6, fontWeight: 500 }}>اختر الشركة</label>
        ...
        <div className="card" style={{ background: '#fff', borderRadius: 14, padding: '20px 24px', marginBottom: 20, boxShadow: '0 1px 3px rgba(0,0,0,.06)' }}>
          ...
          {[
            ...
            <div key={field.key} style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 11, color: '#6b7280', display: 'block', marginBottom: 4, fontWeight: 500 }}>{field.label}</label>
              <input
