    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <Section title="المالية">
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 14 }}>
          <KPICard label="الإيرادات (آخر 90 يوماً)" value={fmtSAR(financial?.total_revenue)} color={'var(--lv-success)'} />
          <KPICard label="المصاريف (آخر 90 يوماً)" value={fmtSAR(financial?.total_expenses)} color={'var(--lv-danger)'} />
    ...
    <div style={{ background: 'var(--lv-panel)', border: '1px solid var(--lv-line)', borderRadius: 12, padding: '20px 24px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <h3 style={{ fontSize: 14, fontWeight: 600, color: 'var(--lv-fg)', margin: 0 }}>
          مقارنة الإيرادات والمصاريف — آخر 90 يوماً
        </h3>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 14px', background: 'var(--lv-chip)', borderRadius: 8, border: '1px solid var(--lv-line)' }}>
        <span style={{ fontSize: 11, color: 'var(--lv-muted)' }}>
          {hoursAgo !== null
            ? `بيانات محدّثة قبل ${hoursAgo} ساعة — الإيرادات والمصاريف آخر 90 يوماً`
            : 'بيانات مباشرة — الإيرادات والمصاريف آخر 90 يوماً'}
        </span>
        <button
      ...
      {/* KPI Totals */}
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 14 }}>
        <KPICard label="إجمالي الإيرادات (90 يوماً)" value={fmtSAR(totals?.total_revenue)} color={'var(--lv-success)'} />
        <KPICard label="إجمالي المصاريف (90 يوماً)" value={fmtSAR(totals?.total_expenses)} />
